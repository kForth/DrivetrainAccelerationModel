...
if __name__ == "__main__":
    ...
    for ratio in ratios:
        ...
        for point in model.data_points:
            closest_idex = round(point['sim_distance'] / distance_step) * distance_step
            if closest_idex in distances:
                time_to_dist_row[distances.index(closest_idex)] = point['sim_time']
